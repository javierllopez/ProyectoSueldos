...
class AppController {
  ...
  async loadPersonnelAuxiliaryData() {
    ...
    const [deptRes, jobRes, hiRes, unionRes, mutualRes, kinRes, catRes, posRes, servRes, cctRes, modRes, profileRes] = await Promise.all([
  ...
  populateEmployeeSelects(selectedDept = '', selectedJob = '', selectedHi = '', selectedUnion = '', selectedMutual = '', selectedContractModality = '') {
